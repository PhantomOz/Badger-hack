...
import { ContractAbi } from '../contract-info/my_psp';
import QueryMethods from '../query/my_psp';
import BuildExtrinsicMethods from '../build-extrinsic/my_psp';
import TxSignAndSendMethods from '../tx-sign-and-send/my_psp';
import MixedMethods from '../mixed-methods/my_psp';
import EventsClass from '../events/my_psp';
